                                    ...
                                    <div class="box-tools">
                                        ...
                                        <div class="input-group input-group-sm hidden-xs" style="width: 300px;">
                                            <input type="text" name="table_search" class="form-control pull-right"
                                                   id="inputSearchSubject" placeholder="收款项">
                        ...
                        <div class="modal-body">
                            <div class="box-body form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword" class="col-sm-3 control-label">阵营</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label for="inputSubject" class="col-sm-3 control-label">收款项</label>
                                ...
                                <div class="form-group">
                                    <label for="inputAmount" class="col-sm-3 control-label">收款金额</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputAmount" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputIncomeDate" class="col-sm-3 control-label">收款日期</label>
                                    <div class="col-sm-9">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" class="form-control pull-right" id="inputIncomeDate">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    const table = $("#example1").DataTable({
        ...
        "ajax": {
            ...
            url: "<%=basePath%>/permission/income-record-page",
            type: 'POST',
    ...
    $("#btnSave").click(function () {
        ...
        const incomeDate =$("#inputIncomeDate").val();
        ...
        if(!errorMsg) {
            $.ajax({
                //请求服务器网址
                url: "<%=basePath%>/permission/income-record-add",
                //请求类型
                type: "POST",
                //返回值类型
                dataType: "json",
