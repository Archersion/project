                                    ...
                                    <div class="box-tools">
                                        ...
                                        <div class="input-group input-group-sm hidden-xs" style="width: 300px;">
                                            <input type="text" name="table_search" class="form-control pull-right"
                                                   id="inputSearchSubject" placeholder="付款项">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">alert(errorMsg);信息</h4>
                        </div>
                        <div class="modal-body">
                            <div class="box-body form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputSubject" class="col-sm-3 control-label">付款项</label>
                                ...
                                <div class="form-group">
                                    <label for="inputPaymentDate" class="col-sm-3 control-label">付款日期</label>
                                    <div class="col-sm-9">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" class="form-control pull-right" id="inputPaymentDate">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    const table = $("#example1").DataTable({
        ...
        "ajax": {
            ...
            url: "<%=basePath%>/permission/payment-record-page",
            type: 'POST',
    ...
    $("#btnSave").click(function () {
        ...
        const paymentDate =$("#inputPaymentDate").val();
        ...
        if(!errorMsg) {
            $.ajax({
                //请求服务器网址
                url: "<%=basePath%>/permission/payment-record-add",
                //请求类型
                type: "POST",
                //返回值类型
                dataType: "json",
