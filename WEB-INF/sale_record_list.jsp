                                    ...
                                    <div class="box-tools">
                                        ...
                                        <div class="input-group input-group-sm hidden-xs" style="width: 300px;">
                                            <input type="text" name="table_search" class="form-control pull-right"
                                                   id="inputSearchSubject" placeholder="销售物品名">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="box-body form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputSubject" class="col-sm-3 control-label">销售物品名</label>
                                ...
                                <div class="form-group">
                                    <label for="inputsaleDate" class="col-sm-3 control-label">收款日期</label>
                                    <div class="col-sm-9">
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" class="form-control pull-right" id="inputsaleDate">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    const table = $("#example1").DataTable({
        ...
        "ajax": {
            ...
            url: "<%=basePath%>/permission/sale-record-page",
            type: 'POST',
    ...
    $("#btnSave").click(function () {
        ...
        const saleDate =$("#inputsaleDate").val();
        ...
        if(!errorMsg) {
            $.ajax({
                //请求服务器网址
                url: "<%=basePath%>/permission/sale-record-add",
                //请求类型
                type: "POST",
                //返回值类型
                dataType: "json",
